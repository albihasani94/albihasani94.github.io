...
[^edit-1]: **July 28, 2026.** While I keep reviewing every line of Java code myself, I've had to let go in other languages (e.g. Ruby, PHP). An example of that is how I came up with my [reading list page]({{ '/reading/' | relative_url }}) implementation.
